...
export const handlers = [
  ...
  http.get(`${baseURL}/users/:userId`, async () => {
    const resultArray = [
      [await getGetUser200Response(), { status: 200 }],
      [undefined, { status: 404 }],
    ];
  ...
  http.get(`${baseURL}/groups`, async () => {
    const resultArray = [
      [await getGetUserGroups200Response(), { status: 200 }],
    ];
  ...
  http.get(`${baseURL}/users/me/tags`, async () => {
    const resultArray = [
      [await getGetMyUserTags200Response(), { status: 200 }],
    ];
  ...
  http.get(`${baseURL}/users/me/sessions`, async () => {
    const resultArray = [
      [await getGetMySessions200Response(), { status: 200 }],
    ];
